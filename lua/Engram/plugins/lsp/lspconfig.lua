	...
	config = function()
		...
		vim.api.nvim_create_autocmd("LspAttach", {
			...
			callback = function(ev)
				...
				vim.keymap.set("n", "<leader>rsl", ":lsp restart<CR>", opts)
		...
		vim.lsp.config("rust_analyzer", {
			-- We point directly to the binary installed by Mason
			-- This ensures Neovim doesn't get confused by your shell path
			cmd = { "rust-analyzer" },
			filetypes = { "rust" },
			settings = {
				["rust-analyzer"] = {
